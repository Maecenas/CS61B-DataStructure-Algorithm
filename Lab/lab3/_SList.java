...
public class SList {
  ...
  // modify __Slist__, __insertFront__ and __insertEnd__
  ...
  public static void main (String[] args) {
    ...
    SList slt = new SList();
    slt.insertFront(new Integer(6));
    slt.insertEnd(new Integer(9));
    slt.insertEnd(new Integer(12));
    System.out.println(slt);
    slt.insertFront(new Integer(3));
    slt.insertEnd(new Integer(15));
    System.out.println(slt);
