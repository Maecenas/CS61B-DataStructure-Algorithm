...
public class SplayTree implements Dictionary {
  ...
  private void splayNode(BinaryTreeNode node) {
    ...
    while (node.parent != null) {
      if (node.parent.parent == null) {
        ...
        if ((isLeftChild(node.parent, node) && isLeftChild(node.parent.parent, node.parent)) ||
                isRightChild(node.parent, node) && isRightChild(node.parent.parent, node.parent)) {
          zigZig(node);
        } else {
          zigZag(node);
        }
  ...
  private boolean isLeftChild(BinaryTreeNode parent, BinaryTreeNode child) {
  ...
  private boolean isRightChild(BinaryTreeNode parent, BinaryTreeNode child) {
    if (parent != null && child != null) {
