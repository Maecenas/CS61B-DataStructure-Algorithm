...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    int N = table.buckets();
    int c = table.collisions();
    int n = table.entries();
    System.out.println("Report collisions: " + c + " / " + N + " = " + ((double) c) / N);

    System.out.println("Expected collisions: n - N + N * (1 - 1/N)^n = " + ((double) n - N + N * Math.pow(1 - 1.0/N, n)));
