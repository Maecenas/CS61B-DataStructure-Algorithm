...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    if (this.myList instanceof DList) {  
      DListNode inserts = ((DList) myList).newNode(item, (DList) this.myList, this, this.next);
      this.next.prev = inserts;
      this.next = inserts;
      myList.size++;
    }
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    if (this.myList instanceof DList) {
      DListNode inserts = ((DList) myList).newNode(item, (DList) this.myList, this.prev, this);
      this.prev.next = inserts;
      this.prev = inserts;
      myList.size++;
    }
  }
