...
public class Homework3 {
  ...
  public static void smoosh(int[] ints) {
    ...
    java.util.Arrays.fill(ints, currentIndex + 1, ints.length, -1);
    // for (int i = currentIndex + 1; i < ints.length; i++) {
    //   ints[i] = -1;
    // }


    // int[] dup = new int[ints.length()];
    // private int const = ints[0];
    // private int now = ints[1];
    // for (int i = 1; i < ints.length(); i++) {
    //   if (now == const) {
    //     continue;
    //   } else {
    ...
    //   }
    // }
    // java.util.Arrays.fill(dup, dup.length(), ints.length(), -1);
    // return dup;
    }
