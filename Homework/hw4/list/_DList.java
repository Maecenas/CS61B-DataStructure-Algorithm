...
public class DList {
  ...
  public void insertFront(Object item) {
    DListNode inserts = newNode(item, head, head.next);
    head.next.prev = inserts;
    head.next = inserts;
    size++;
  }
  ...
  public void insertBack(Object item) {
    DListNode inserts = newNode(item, head.prev, head);
    head.prev.next = inserts;
    head.prev = inserts;
    size++;
  }
  ...
  public void insertAfter(Object item, DListNode node) {
    if (node != null) {
      DListNode inserts = newNode(item, node, node.next);
      node.next.prev = inserts;
      node.next = inserts;
      size++;
    }
  }
  ...
  public void insertBefore(Object item, DListNode node) {
    if (node != null) {
      DListNode inserts = newNode(item, node.prev, node);
      node.prev.next = inserts;
      node.prev = inserts;
      size++;
    }
  }
